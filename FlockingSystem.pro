...
#####
##### Starting here, this project file is a copy of Jon Macey's project file in the SimpleNGL demo.
##### The additions above were made to make the project build on my macbook.
#####
...
# unix:LIBS += -L/usr/local/lib ############################### @Change: Commented this line to get rid of warnings. Might need it in the lab!
# add the ngl lib
