...
# Template: app
# Command: /Users/pieterjanbartels/Applications/Qt/5.3/clang_64/bin/qmake -spec macx-clang CONFIG+=debug CONFIG+=x86_64 -o Makefile FlockingSystem.pro
#############################################################################
...
QMAKE         = /Users/pieterjanbartels/Applications/Qt/5.3/clang_64/bin/qmake
TAR           = tar -cf
COMPRESS      = gzip -9f
COPY          = cp -f
SED           = sed
...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents include/Agent.h include/BasicBehaviours.h include/EcoSystem.h include/ExplicitEulerIntegrator.h include/Flock.h include/FlockUi.h include/GLWindow.h include/IBehaviour.h include/IBrain.h include/Locomotion.h obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents src/Agent.cpp src/BasicBehaviours.cpp src/Brains.cpp src/EcoSystem.cpp src/ExplicitEulerIntegrator.cpp src/Flock.cpp src/FlockUi.cpp src/GLWindow.cpp src/Locomotion.cpp src/main.cpp obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents ui/FlockUi.ui obj/FlockingSystem1.0.0/ && (cd `dirname obj/FlockingSystem1.0.0` && $(TAR) FlockingSystem1.0.0.tar FlockingSystem1.0.0 && $(COMPRESS) FlockingSystem1.0.0.tar) && $(MOVE) `dirname obj/FlockingSystem1.0.0`/FlockingSystem1.0.0.tar.gz . && $(DEL_FILE) -r obj/FlockingSystem1.0.0
...
ui_FlockUi.h: ui/FlockUi.ui
	/Users/pieterjanbartels/Applications/Qt/5.3/clang_64/bin/uic ui/FlockUi.ui -o ui_FlockUi.h
...
obj/Locomotion.o: src/Locomotion.cpp include/Locomotion.h \
		include/ExplicitEulerIntegrator.h \
		include/Agent.h \
		/Users/pieterjanbartels/NGL/include/ngl/Vec3.h \
		/usr/local/include/boost/python.hpp \
		...
		/Users/pieterjanbartels/Applications/Qt/5.3/clang_64/lib/QtOpenGL.framework/Versions/5/Headers/QGLContext \
		/Users/pieterjanbartels/Applications/Qt/5.3/clang_64/lib/QtOpenGL.framework/Versions/5/Headers/qgl.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/Locomotion.o src/Locomotion.cpp
