...
DIST          = .qmake.cache \
		.qmake.stash \
		FlockingSystem.pro src/Brains.cpp \
		src/EcoSystem.cpp \
		src/ExplicitEulerIntegrator.cpp \
		src/Flock.cpp \
		src/FlockUi.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents include/Agent.h include/BasicBehaviours.h include/EcoSystem.h include/ExplicitEulerIntegrator.h include/Flock.h include/FlockControl.h include/FlockUi.h include/GLWindow.h include/IBehaviour.h include/IBrain.h obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents src/Brains.cpp src/EcoSystem.cpp src/ExplicitEulerIntegrator.cpp src/Flock.cpp src/FlockUi.cpp src/GLWindow.cpp src/main.cpp obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents ui/FlockUi.ui obj/FlockingSystem1.0.0/ && (cd `dirname obj/FlockingSystem1.0.0` && $(TAR) FlockingSystem1.0.0.tar FlockingSystem1.0.0 && $(COMPRESS) FlockingSystem1.0.0.tar) && $(MOVE) `dirname obj/FlockingSystem1.0.0`/FlockingSystem1.0.0.tar.gz . && $(DEL_FILE) -r obj/FlockingSystem1.0.0
