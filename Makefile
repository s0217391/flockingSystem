...
SOURCES       = src/EcoSystem.cpp \
		src/Flock.cpp \
		src/FlockUi.cpp \
		src/GLWindow.cpp \
		src/main.cpp moc/moc_FlockUi.cpp
OBJECTS       = obj/EcoSystem.o \
		obj/Flock.o \
		obj/FlockUi.o \
		obj/GLWindow.o \
		obj/main.o \
...
DIST          = .qmake.cache \
		.qmake.stash \
		FlockingSystem.pro src/EcoSystem.cpp \
		src/Flock.cpp \
		src/FlockUi.cpp \
		src/GLWindow.cpp \
		src/main.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(DIST) obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents include/Agent.h include/EcoSystem.h include/Flock.h include/FlockControl.h include/FlockUi.h include/GLWindow.h include/IBehaviour.h include/IBrain.h obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents src/EcoSystem.cpp src/Flock.cpp src/FlockUi.cpp src/GLWindow.cpp src/main.cpp obj/FlockingSystem1.0.0/ && $(COPY_FILE) --parents ui/FlockUi.ui obj/FlockingSystem1.0.0/ && (cd `dirname obj/FlockingSystem1.0.0` && $(TAR) FlockingSystem1.0.0.tar FlockingSystem1.0.0 && $(COMPRESS) FlockingSystem1.0.0.tar) && $(MOVE) `dirname obj/FlockingSystem1.0.0`/FlockingSystem1.0.0.tar.gz . && $(DEL_FILE) -r obj/FlockingSystem1.0.0
...
obj/EcoSystem.o: src/EcoSystem.cpp include/EcoSystem.h \
		include/Flock.h \
		include/Agent.h \
		/home/i7674211/NGL/include/ngl/Vec3.h \
		/home/i7674211/NGL/include/ngl/Types.h \
